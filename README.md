...
+ Установлен molecule, testinfra
+ Оттестировано локальное поднятие окружений

###  Примечания

+ Откровенно говоря для меня это оказалось просто кошмарным заданием. Начиная с установки виртуалок в виртуалку, заканчивая установкой molecule через pip. Первый раз, за весь курс, все пошло наперекосяк :)
